...
void {\bfseries master\+\_\+work2} (int rank, int size, graph\+\_\+t $\ast$graph, \mbox{\hyperlink{structscc__set__t}{scc\+\_\+set\+\_\+t}} $\ast$SCCs, char $\ast$outputfilename, double time\+\_\+init)
\item 
